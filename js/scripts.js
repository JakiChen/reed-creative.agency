/*--------------------------------------------------
  Adobe Typekit Fonts 
  01. "Source-han-sans-simplified-c"
---------------------------------------------------*/
(function (d) {
	var config = {
			kitId: 'eus4mwj',
	...
	if ($('#portfolio-wrap').length > 0) {
		...
		$(window).on('resize', function () {
			...
			if (winWidth >= 1466) {
				...
				$('#portfolio-wrap').css({
					width: $('#portfolio-wrap').parent().width() - 400 + 'px'
				});
				$('#portfolio-wrap.packery-mode').css({
					width: $('#portfolio-wrap').parent().width() - 380 + 'px'
				});
				...
				$('#portfolio-wrap').css({
					width: $('#portfolio-wrap').parent().width() - 160 + 'px'
				});
				$('#portfolio-wrap.packery-mode').css({
					width: $('#portfolio-wrap').parent().width() - 140 + 'px'
				});
				var portfolioWidth = $('#portfolio-wrap').width();
				...
				$('#portfolio-wrap').css({
					width: $('#portfolio-wrap').parent().width() + 'px'
				});
				$('#portfolio-wrap.packery-mode').css({
					width: $('#portfolio-wrap').parent().width() - 40 + 'px'
				});
				var portfolioWidth = $('#portfolio-wrap').width();
				...
				$('#portfolio-wrap.packery-mode').css({
					width: $('#portfolio-wrap').parent().width() - 60 + 'px'
				});
				var portfolioWidth = $('#portfolio-wrap').width();
				...
				$('#portfolio-wrap.packery-mode').css({
					width: $('#portfolio-wrap').parent().width() - 20 + 'px'
				});
				var portfolioWidth = $('#portfolio-wrap').width();
